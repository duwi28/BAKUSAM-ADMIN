...
const styles = StyleSheet.create({
  ...
  acceptButtonWithTalangan: {
    backgroundColor: '#FF9800',
  },
  
  // Talangan Modal styles
  talanganModalContent: {
    backgroundColor: 'white',
    margin: 20,
    padding: 20,
    borderRadius: 16,
  ...
  modalTalanganWarning: {
    fontSize: 11,
    color: '#E65100',
    marginTop: 5,
    fontWeight: '500',
  },
  talanganConfirmSection: {
    backgroundColor: '#F3E5F5',
    padding: 15,
    borderRadius: 12,
    marginBottom: 15,
  },
  talanganConfirmTitle: {
    fontSize: 16,
    fontWeight: 'bold',
    color: '#4A148C',
    marginBottom: 10,
  ...
  talanganModalButtons: {
    flexDirection: 'row',
    justifyContent: 'space-between',
  },
  rejectTalanganButton: {
    flex: 1,
    backgroundColor: '#F44336',
    padding: 15,
    borderRadius: 12,
  ...
  rejectTalanganButtonText: {
    color: 'white',
    fontWeight: 'bold',
    fontSize: 14,
  },
  acceptTalanganButton: {
    flex: 1,
    backgroundColor: '#FF9800',
    padding: 15,
    borderRadius: 12,
